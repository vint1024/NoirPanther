...
> - Current release: **`0.1.7-r1`** = everything in Stump **0.1.7** + [what this fork adds](#what-this-fork-adds). See [Versioning](#versioning).
>
...
| `ghcr.io/vint1024/noirpanther:0.1.7-r1` | exactly this release (pinned — updates only when you change it) |
...
Each release is a git tag `v<version>` (e.g. `v0.1.7-r1`), a [GitHub release](https://github.com/vint1024/NoirPanther/releases)
...
- Version **`0.1.7-r1`** (see [Versioning](#versioning)), build channel **`NoirPanther (stable)`**
